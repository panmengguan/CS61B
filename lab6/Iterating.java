...
public class Iterating {
    ...
    static Filter<Integer> everyFourth(Iterator<Integer> input) {
        AlternatingFilter<Integer> af =
            new AlternatingFilter<Integer>(input);

        return new AlternatingFilter<Integer>(af);
    }
    ...
    public static void main(String... unused) {
        ...
        Filter<Integer> f5 = new MonotonicFilter<Integer>(test.iterator());
        printAll(f5);
    }
