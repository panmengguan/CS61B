...
public class RationalTest {
    ...
    @Test public void str1() {
        Rational rat1 = frac("4");

        assertTrue("Result should be 4/1",
                   rat1.numer() == 4 && rat1.denom() == 1);

        assertTrue("Result should be true",
                   rat1.equal(frac(8, 2)));

        Rational rat2 = frac("+8/2");

        assertTrue("Result should be 4/1",
                   rat2.numer() == 4 && rat2.denom() == 1);

        assertTrue("Result should be true",
                   rat2.equal(frac(8, 2)));
    }

    @Test public void str2() {
        Rational rat1 = frac("-4");
    ...
    @Test public void str3() {
        Rational rat1 = frac("8/2");
